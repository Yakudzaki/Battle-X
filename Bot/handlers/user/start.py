...
async def start(message: types.Message):
    ...
    await message.answer('Приветик! 👋\n\n'
                        ...
                        '🤝 А еще, если хочешь заказать похожего бота, свяжись с <a href="https://t.me/Yakudza_Drill">Yakudza</a> или <a href="https://t.me/x_FouR_x">Four</a>', reply_markup=markup, disable_web_page_preview=True)
